...
static __inline void AES256_ECB(unsigned char *key, unsigned char *ctr,
...
static void randombytes_init_nist(unsigned char *entropy_input,
...
static int randombytes_nist(unsigned char *x, size_t xlen) {
...
void randombytes_init(unsigned char *entropy_input,
                      unsigned char *personalization_string,
                      int security_strength) {
  return randombytes_init_nist(entropy_input, personalization_string,
                               security_strength);
}
