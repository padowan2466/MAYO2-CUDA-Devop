...
static __constant__ int a[25] = {0,  6,  12, 18, 24, 1,  7, 13, 19,
                                 20, 2,  8,  14, 15, 21, 3, 9,  10,
                                 16, 22, 4,  5,  11, 17, 23};

static __constant__ int b[25] = {0, 1, 2, 3, 4, 1, 2, 3, 4, 0, 2, 3, 4,
...
static __constant__ int d[25] = {0,  1,  2,  3,  4,  10, 11, 12, 13,
                                 14, 20, 21, 22, 23, 24, 5,  6,  7,
                                 8,  9,  15, 16, 17, 18, 19};

// __device__ void process_block(uint64_t *A);
// __device__ void shake256_gpu(uint64_t *out, uint64_t *in, size_t inlen,
// uint32_t outlen, uint32_t out_stride) ;
